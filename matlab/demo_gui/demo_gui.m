...
%             gen_wave_labels(l,(1:max_time)) ;
        ...
        if isempty(er)
            ...
            for i = 1:num_erays
                ...
                for j = 1:(length(wavefront.source_az)-1)
                    if eigenrays(tar_num,1).source_az(i) >= wavefront.source_az(j) && ...
                        eigenrays(tar_num,1).source_az(i) <= wavefront.source_az(j+1)
                        if abs(abs((eigenrays(tar_num,1).source_az(i)) - abs(wavefront.source_az(j)))) ...
                                < abs(abs((eigenrays(tar_num,1).source_az(i)) - abs(wavefront.source_az(j+1))))
                            m(i) = j ;
                        else
                            m(i) = j+1 ;
                        end
            ...
            for i = 1:length(er)
                ...
                for j = 1:(length(wavefront.source_az)-1)
                    if eigenrays(tar_num,1).source_az(er(i)) >= wavefront.source_az(j) && ...
                        eigenrays(tar_num,1).source_az(er(i)) <= wavefront.source_az(j+1)
                        if abs(abs((eigenrays(tar_num,1).source_az(er(i))) - abs(wavefront.source_az(j)))) ...
                                < abs(abs((eigenrays(tar_num,1).source_az(er(i))) - abs(wavefront.source_az(j+1))))
                            m(i) = j ;
                        else
                            m(i) = j+1 ;
                        end
    ...
    function neighbor_plot
        ...
        for j = 1:(length(wavefront.source_az)-1)
            if eigenrays(tar_num,1).source_az(er) >= wavefront.source_az(j) && ...
                eigenrays(tar_num,1).source_az(er) <= wavefront.source_az(j+1)
                if abs(abs((eigenrays(tar_num,1).source_az(er)) - abs(wavefront.source_az(j)))) ...
                        < abs(abs((eigenrays(tar_num,1).source_az(er)) - abs(wavefront.source_az(j+1))))
                    m = j ;
                else
                    m = j+1 ;
                end
