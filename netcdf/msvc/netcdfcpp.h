 ...
 * **********************************************************************
 */
class USML_DECLSPEC NcTypedComponent
{
  public:
 ...
 * **********************************************************************
 */
class USML_DECLSPEC NcVar : public NcTypedComponent
{
  public:
    virtual ~NcVar( void );
    NcToken name( void ) const;
