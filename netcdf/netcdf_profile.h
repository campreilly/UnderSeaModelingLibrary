 ...
 *
 * - The first dimension of the sound speed is assumed to be month.
 * - The second dimension of the sound speed is assumed to be depth.
 *   The negative of the depth value must be used to convert into the
 *   negative altitude form used in the rest of our coordinate system.
 * - The third dimension of the depth is assumed to be latitude.
 * - The forth dimension of the depth is assumed to be longitude.
