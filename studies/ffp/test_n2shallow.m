...
kmin = 7.515 ;                  % minimum wavenumber for integration (1/m)
kmax = 10.0 ;                   % maximum wavenumber for integration (1/m)
rmin = 500 ;                    % minimum range for solution (meters)
rmax = 1000 ;                   % maximum range to plot in solution (meters)
...
z = 75.0 ;                      % target depths (meters)
zs = 75.0 ;                     % source depth (meters)
