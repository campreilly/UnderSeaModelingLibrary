/**
 * @example test_loss_calops.cc
 */
#include <fstream>
#include <usml/ocean/ocean.h>
#include "reflect_loss_calops.h"
...
int main( int argc, char* argv[] ) {
    cout << "=== test_loss_calops ===" << endl ;
    const char* name = "test_loss_calops.csv" ;
    std::ofstream os(name) ;
    cout << "writing tables to " << name << endl ;

    ascii_arc_bathy bathymetry( STUDIES_FLORIDA_STRAITS_BATHYMETRY ) ;

    reflect_loss_calops bottom( &bathymetry ) ;
