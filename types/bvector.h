...
class USML_DECLSPEC bvector {
   ...
   public:
     ...
     */
    bvector(vector<double> v) { _vector = v; }
     ...
     * @param v vector to copy.
     */
    bvector(const bvector& v) { _vector = v._vector; }
     ...
     */
    double front() const { return _vector(0); }
     ...
     */
    void front(double f) { _vector(0) = f; }
     ...
     */
    double right() const { return _vector(1); }

    /**
     * Updates vector component toward the right side of the object.
     * @param r Offset toward the right side of the object (meters).
     */
    void right(double r) { _vector(1) = r; }
